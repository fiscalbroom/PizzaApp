...
import 'package:pizzaapp/widgets/add_to_cart_button.dart';
import 'package:pizzaapp/widgets/custom_radio.dart';
...
class HomePizzaDetails extends StatefulWidget {
  ...
  const HomePizzaDetails(
      {required this.pizza, required this.avalibleToppings,required this.onDragStarted})
      : super();
...
class BuildTopping extends StatelessWidget {
  ...
  BuildTopping({required this.onDragStarted,required this.image,required this.toppingData});
...
class ToppingOnPizza extends StatelessWidget {
  ...
  const ToppingOnPizza({this.shouldAnimate = false, required this.toppingData});
  @override
  Widget build(BuildContext context) {
    return Container(
      alignment: Alignment.center,
